...
class FluThemeUtils : public QObject
{
  ...
  public:
    ...
    static QColor getThemeColorNormal();
    static QColor getThemeColorLight();
    static QColor getThemeColorLighter();
    static QColor getThemeColorLightest();
    static QColor getThemeColorDark();
