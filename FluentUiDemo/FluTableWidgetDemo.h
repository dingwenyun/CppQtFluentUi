...
#include "../FluentUiControl/FluTableView.h"
#include <QHBoxLayout>
#include "../FluentUiControl/FluTableWidget.h"
#include <QHeaderView>

class FluTableWidgetDemo : public QWidget
{
  public:
    FluTableWidgetDemo(QWidget* parent = nullptr) : QWidget(parent)
    {
        m_hLayout = new QHBoxLayout(this);
        m_tableWidget = new FluTableWidget(this);
        m_tableWidget->setWordWrap(false);
        m_tableWidget->setRowCount(30);
        ...
        QHeaderView* headerView = new QHeaderView(Qt::Orientation::Horizontal, m_tableWidget);
        m_tableWidget->setHorizontalHeaderLabels({"Title", "Artist", "Album", "Year", "Duration"});
        m_tableWidget->resizeColumnsToContents();

        setStyleSheet("FluTableWidgetDemo{background: rgb(249, 249, 249)} ");
        m_hLayout->setContentsMargins(50, 50, 50, 50);
        m_hLayout->addWidget(m_tableWidget);
        resize(700, 700);
    }
